...
public class Menu extends JPanel {
	...
	JButton diaDezAtras = new JButton("<<");
	JButton diaDezFrente = new JButton(">>");
...
//				if (a.getNome().equalsIgnoreCase("PETR4") || a.getNome().equalsIgnoreCase("VALE5"))
		...
		diaDezAtras.addActionListener(new AtrasDezDiasIntervaloListener());
		diaDezFrente.addActionListener(new FrenteDezDiasIntervaloListener());
		...
		this.add(diaAtras);
		this.add(diaFrente);
		this.add(diaDezAtras);
		this.add(diaDezFrente);
	...
	class FrenteDezDiasIntervaloListener implements ActionListener {
		public void actionPerformed(ActionEvent evt) {
			MainFrame.nextDezDias();

		}
	}

	class AtrasDezDiasIntervaloListener implements ActionListener {
		public void actionPerformed(ActionEvent evt) {
			MainFrame.lastDezDias();
		}
	}
